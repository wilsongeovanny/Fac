...
<script type="text/javascript">
  function cargarv(id){
    ...
    var data;
    $.ajax({
      url: '../controladores/visto.php?empleadocedula='+a,
      type: 'GET',
      data: data,         
  ...
  <div class="">
    <div class="x_panel">
      ...
      <form action="<?php echo SERVERURL; ?>ajax/manteEntregaAjax.php" method="POST" data-form="save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
        ...
        <input name="esman-reg" type="hidden" value="<?php echo $campos['estadomantenimientocodigo']; ?>"></input>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12  form-group">         
            <div class="">
              <input class="form-control" data-validate-length-range="6" data-validate-words="2" type="text" name="serie-reg" disabled="disabled" value="<?php echo $campos['colorhardwarenombre']; ?>" required="required" />
            </div>
          </div>
          <div class="col-md-6 col-sm-12  form-group">         
            <div class="">
          ...
          <div class="col-md-6 col-sm-12  form-group">        
            <div class="">
              <input class="form-control" type="time" data-validate-length-range="6" data-validate-words="2" name="hora-reg" disabled="disabled" value="<?php echo $campos['ingresohora']; ?>" placeholder="HORA"  />
            </div>
          </div>
          <div class="col-md-6 col-sm-12  form-group">         
            <div class="">
              <input class="form-control" type="date" tdata-validate-length-range="6" data-validate-words="2" name="fecha-reg" disabled="disabled" value="<?php echo $campos['ingresofecha']; ?>" placeholder="FECHA" />
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-12  form-group">        
            <div class="">
              <input class="form-control" type="time" data-validate-length-range="6" data-validate-words="2" name="hentrega-reg" placeholder="HORA" />
            </div>
          </div>
          <div class="col-md-6 col-sm-12  form-group">         
            <div class="">
              <input class="form-control" type="date" tdata-validate-length-range="6" data-validate-words="2" name="fentrega-reg" placeholder="FECHA" />
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-12 form-group">
            ...
            ?>
            <select class="form-control" name="tipom-reg" placeholder="" required="required">
              <?php
          ...
          <div class="col-md-12 col-sm-12 form-group">         
            <div class="">
              <label for="message">Descripción del servicio realizado (max 255):</label>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h4 class="modal-title" id="bs-example-modal-lg">Empleados del sistemas activos</h4>
      ...
      <div class="ln_solid">
        <div class="form-group">
          <div style="display: block; margin-left: auto; margin-right: auto;">
            <button type='submit' class="btn btn-primary">Generar informe técnico</button>
...
<?php }else{ ?>
  <div class="alert alert-dismissible alert-primary text-center">
    ...
    <h4>¡Lo sentimos!</h4>
    <p>Los dos estados del empleado ya se encuentran registrados por lo tanto ya no puede registrar más</p>
  </div>
  <?php } ?>