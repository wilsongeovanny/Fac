...
if ($filesEs->rowCount()==1) {
  ...
  <div class="">
    <div class="x_panel">
     ...
     <form action="<?php echo SERVERURL; ?>ajax/reasignacionAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">

      <input type="hidden" name="codigo" value="<?php echo $verificar; ?>">
      <input type="hidden" name="codigo-up" value="<?php echo $campos['hiserie']; ?>">
      <input type="hidden" name="siesta-up" value="<?php echo $campos['hardwareqr']; ?>">
      
      
      <h2 class="StepTitle">Información del hardware a reasignar</h2><br>
      <div class="row">
                    ...
                    foreach ($datos as $rows) {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          onclick="cargarre('<?php echo trim($rows['empleadocedula'])."&inv=".$inv."&serie=".$ser ?>')"></i> Seleccionar
                        </a>
                      </td>
                    <?php } ?>
...
<div class="ln_solid">
  <div class="form-group">
    <div class="col-md-9 offset-md-5">
      <button type='submit' class="btn btn-primary"><i class="fa fa-sign-out"></i> Reasignar</button>
