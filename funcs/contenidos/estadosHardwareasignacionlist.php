                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Listado de estados de asignación y reasignación <small></small></h2>
                                  ...
                                  <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        ...
                                        <table id="datatable" class="table table-bordered" style="width:100%">
                                          ...
                                          $insAdmin= new estadosHardwareControlador();
                                          ?>
                                          <?php 
                                          
                                          echo $insAdmin->listar_estadosHardware_controlador();
                                          ?>  
