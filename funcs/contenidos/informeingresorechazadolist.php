                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Listado de hardware rechazado con sus informes <small></small></h2>
                                  ...
                                  <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                          ...
                                          $insAdmin= new infoingresoHardControlador();
                                          ?>
                                          <?php 
                                          
                                          echo $insAdmin->listar_infoingresorechazo_controlador();
                                          ?>  
