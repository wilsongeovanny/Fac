          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sección Marcas de Hardware<small></small></h2>
                  ...
                  $filesEs=$iEs->datos_marcasHardware_controlador("Unico",$verificar);
                  ...
                  if ($filesEs->rowCount()==1) {
                    ...
                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Editar la marca de hardware <small></small></h2>
                          <div class="clearfix"></div>
                        </div>
                        
                        <form action="<?php echo SERVERURL; ?>ajax/marcaHardwareAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                                                        <!--
                                                      ...
                                                      <input type="hidden" name="codigo-up" value="<?php echo $campos['marcahardwarecodigo']; ?>">
                                                            ...
                                                            <select class="form-control" name="opcion-up" placeholder="" required="required">
                                                              <?php
                                                                ...
                                                                <div class="field item form-group">
                                                                  ...
                                                                  <div class="col-md-6 col-sm-6">
                                                                    <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="nombre-up" placeholder="" value="<?php echo trim($campos['marcahardwarenombre']); ?>"/>
                                                                  </div>
                                                                </div>
                                                                ...
                                                                <div class="ln_solid">
                                                                  <div class="form-group">
                                                                    <div class="col-md-6 offset-md-3">
                                                                      ...
                                                                      <!--<a href="<?php echo SERVERURL; ?>/marcashardware/" class="btn btn-secondary">Regresar</a>-->
