          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sección Estados de Hardware <small></small></h2>
                  ...
                  $filesEs=$iEs->datos_estadosHardwarevida_controlador("Unico",$datos[1]);
                  ...
                  if ($filesEs->rowCount()==1) {
                    ...
                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Editar el estado del hardware <small></small></h2>
                          <div class="clearfix"></div>
                        </div>
                        
                        <form action="<?php echo SERVERURL; ?>ajax/estadosHardwarevidaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                                                        <!--
                                                      ...
                                                      <input type="hidden" name="codigo-up" value="<?php echo $campos['ESTADOHARDWARECODIGO']; ?>">
                                                        ...
                                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Estado<span class="required">:</label>
                                                          <div class="col-md-6 col-sm-6 ">
                                                            <select class="form-control" name="opcion-up" placeholder="" required="required">
                                                              <option value="<?php echo $campos['ESTADOHARDWARENOMBRE']; ?>">"<?php echo $campos['ESTADOHARDWARENOMBRE']; ?>"</option>
                                                        ...
                                                        <div class="ln_solid">
                                                          <div class="form-group">
                                                            <div class="col-md-6 offset-md-3">
                                                              ...
                                                              <a href="<?php echo SERVERURL; ?>/estadosHardware/" class="btn btn-secondary">Regresar</a>
