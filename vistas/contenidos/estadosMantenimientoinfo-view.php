          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sección estados de Mantenimiento<small></small></h2>
                  ...
                  $filesEs=$iEs->datos_estadosMantenimiento_controlador("Unico",$datos[1]);
                  ...
                  if ($filesEs->rowCount()==1) {
                    ...
                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Editar el estado del mantenimiento  <small></small></h2>
                          <div class="clearfix"></div>
                        </div>
                        
                        <form action="<?php echo SERVERURL; ?>ajax/estadosMantenimientoAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                                                        <!--
                                                      ...
                                                      <div class="field item form-group">
                                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Estado <span class="required">:</label>
                                                          <div class="col-md-6 col-sm-6 ">
                                                              <!--<?php
                                                                    $iEs= new estadosMantenimientoControlador();
                                                                    $cEs=$iEs->datos_estadosMantenimiento_controlador("Select",0);
                                                                ?>
                                                                <select class="form-control" name="opcion-up" onchange="cargarDep(this)" placeholder="" required="required">
                                                                    <?php
                                                                        while($campos1=$cEs->fetch()){
                                                                    ?>
                                                                        <option <?php if ($campos['ESTADOMANTENIMIENTONOMBRE']==$campos1['ESTADOMANTENIMIENTONOMBRE']) echo('selected')?> value="<?php echo($campos1['ESTADOMANTENIMIENTONOMBRE']); ?>"><?php echo($campos1['ESTADOMANTENIMIENTONOMBRE']); ?></option>
                                                                  ...
                                                                  <select class="form-control" name="opcion-up" placeholder="" required="required"> 
                                                                    <option value="<?php echo($campos['ESTADOMANTENIMIENTONOMBRE']); ?>">"<?php echo($campos['ESTADOMANTENIMIENTONOMBRE']); ?>"</option>
                                                              ...
                                                              <div class="ln_solid">
                                                                <div class="form-group">
                                                                  <div class="col-md-6 offset-md-3">
                                                                    ...
                                                                    <a href="<?php echo SERVERURL; ?>/estadosMantenimiento/" class="btn btn-secondary">Regresar</a>
