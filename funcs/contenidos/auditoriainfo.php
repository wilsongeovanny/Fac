...
$iEs= new reasignacionControlador();
$filesEs=$iEs->datos_reasignacion_controlador("Tipo",$verificar);
      ...
      foreach ($datos as $rows) {
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12  form-group">
            ...
            <input class="form-control" type="text" class="text" name="apellidos-up" data-validate-length-range="6" data-validate-words="2" placeholder="INGA LEMA" required="required" value="<?php echo trim($rows['empleadoapellidos'])." ".trim($rows['empleadonombres']); ?>" disabled="disabled"/>
          </div>
          ...
          <?php
          $codigo=trim($rows['codigoauditoria']);
          ...
          $nombres=trim($CodRespo['empleadonombres']);
          $apellidos=trim($CodRespo['empleadoapellidos']);
          ...
          <div class=''>
          <input class='form-control' data-validate-length-range='6' data-validate-words='2' name='marca-up' placeholder='INGRESE EL # DE SERIE' required='required' value='".$apellidos.' '.$nombres."' disabled='disabled'/>
          </div>
          </div>";
