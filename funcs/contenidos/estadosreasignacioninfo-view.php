          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sección Estados de Reasignación de Hardware<small></small></h2>
                  ...
                  $filesEs=$iEs->datos_estadosReasig_controlador("Unico",$datos[1]);
                  ...
                  if ($filesEs->rowCount()==1) {
                    ...
                    <div class="">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Editar estado de reasignación <small></small></h2>
                          <div class="clearfix"></div>
                        </div>
                        
                        <form action="<?php echo SERVERURL; ?>ajax/estadosReasignacionAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                                                        <!--
                                                      ...
                                                      <div class="field item form-group">
                                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Estado de reasignación<span class="required">:</label>
                                                          <div class="col-md-6 col-sm-6 ">
                                                            <select class="form-control" name="opcion-up" placeholder="" required="required" <?php echo $campos['ESTADOASIGHARNOMBRE']; ?>>
