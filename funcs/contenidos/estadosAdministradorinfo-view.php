    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          $filesEs=$iEs->datos_estadosCuenta_controlador("Unico",$datos[1]);
          ...
          if ($filesEs->rowCount()==1) {
            ...
            <div class="">
              <div class="x_panel">
                ...
                <form action="<?php echo SERVERURL; ?>ajax/estadosCuentaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
                                                        <!--
                                                      ...
                                                      <div class="field item form-group">
                                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Estado <span class="required">:</label>
                                                          <div class="col-md-6 col-sm-6 ">
                                                            <select class="form-control" name="opcion-up" placeholder="" required="required" <?php echo $campos['ESTADOEMPLEADONOMBRE']; ?>>
                                                        ...
                                                        <div class="ln_solid">
                                                          <div class="form-group">
                                                            <div class="col-md-6 offset-md-3">
                                                              ...
                                                              <a href="<?php echo SERVERURL; ?>/estadosCuenta/" class="btn btn-success">Regresar</a>
