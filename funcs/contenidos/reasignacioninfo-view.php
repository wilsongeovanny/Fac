    ...
    <div class="row">
                    ...
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Auditorias</a>
                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          <?php require_once 'reasignacion.php' ?>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                         <?php require_once 'auditoriainfo.php' ?>
                       </div>
     ...
     <?php }else{ ?>
      <div class="alert alert-dismissible alert-warning text-center">
        ...
        <h4>¡Lo sentimos!</h4>
        <p>No hemos podido encontra información del mantenimiento, por favor intente nuevamente</p>
      </div>
    <?php } ?>
  </div>
</div>
