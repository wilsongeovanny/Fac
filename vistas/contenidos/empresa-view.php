                                    ...
                                    <div class="">
                                        ...
                                        <form class="" action="" method="post" novalidate>
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" data-validate-length-range="6" data-validate-words="1" name="name" placeholder="ejem. PARQUE VICENTE LEÓN" required="required" />
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align">Logo <span class="required">:</span></label>
                                                <div class="col-md-8 col-sm-8">
                                                    <input class="form-control" type="file" data-validate-length-range="6" data-validate-words="1" name="name" placeholder="ejem. PARQUE VICENTE LEÓN" required="required" />
                                                </div>
                                            </div>
