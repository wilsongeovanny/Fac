...
$cEs=$iEs->datos_estadosEmpleado_controlador("Conteo",0);
    ...
    if ($cEs->rowCount()<=1) { //Son mas de un servicio
        ...
        <div class="">
            <div class="x_panel">
              <div class="x_title">
                <h2>Agregar nuevo estado al empleado <small></small></h2>
                <div class="clearfix"></div>
            </div>
            <form action="<?php echo SERVERURL; ?>ajax/estadosEmpleadoAjax.php" method="POST" data-form="save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
